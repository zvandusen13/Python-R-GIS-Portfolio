...
parcel_shapefile <- st_read("/Users/zachvandusen/Desktop/Bates_Property_Project/Lewiston_batesvicinityselection/LewistonBuildings_batesvicinityselection.shp")
